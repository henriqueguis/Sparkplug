...
from SparkplugB import sparkplug_b_pb2
import certifi
import time
import random
import string
...
client.connect(serverUrl, 8884, 60)
...
client.subscribe("spBv1.0/" + myGroupId + "/DDATA/" + myNodeName + "/" + myDeviceName, 0, False)
...
while True:
    ...
    addMetric(payload, None, AliasMap.Device_Metric0, MetricDataType.String, "Teste Python Henrique")
